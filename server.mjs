...
router.post("/generate-proposal", async (req, res) => {
  const { id, title, description, name, client_public_name, ai_templates } = req.body;
  ...
  const result = await generateAIProposal(client_public_name, title, description, name , ai_templates);
